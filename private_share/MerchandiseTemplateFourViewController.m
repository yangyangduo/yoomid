//
//  MerchandiseTemplateFourViewController.m
//  private_share
//
...
@interface MerchandiseTemplateFourViewController ()

@end

@implementation MerchandiseTemplateFourViewController
{
...
- (void)viewDidLoad {
    ...
    [_collectionView registerClass:[MerchandiseTemplateFourCell class] forCellWithReuseIdentifier:_cell_identifier_];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    MerchandiseTemplateFourCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:_cell_identifier_ forIndexPath:indexPath];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    size = CGSizeMake(viewheight, viewheight+40);
    return size;
}
