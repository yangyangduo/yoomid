...
{
    [self.httpClient get:[NSString stringWithFormat:@"/activities?shopId=all&%@", self.authenticationString] target:target success:success failure:failure userInfo:nil];
}
@end
