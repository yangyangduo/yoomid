...
// 弹出广告加载完成
typedef void (^PBInterstitialDidLoadAD)();
// 弹出广告加载出错
typedef void (^PBInterstitialLoadFailure)(PBRequestError *error);
// 弹出广告打开完成
typedef void (^PBInterstitialDidPresent)();
// 弹出广告倒计时结束
typedef void (^PBInterstitialCountDownFinished)();
// 弹出广告将要关闭
typedef void (^PBInterstitialWillDismiss)();
// 弹出广告关闭完成
typedef void (^PBInterstitialDidDismiss)();
...
// 弹出广告加载完成的block
@property (nonatomic, copy) PBInterstitialDidLoadAD didLoadAD;
// 弹出广告加载出错的block
@property (nonatomic, copy) PBInterstitialLoadFailure loadADFailure;
// 弹出广告打开完成的block
@property (nonatomic, copy) PBInterstitialDidPresent didPresent;
// 弹出广告倒计时结束的block
@property (nonatomic, copy) PBInterstitialCountDownFinished countDownFinished;
// 弹出广告将要关闭的block
@property (nonatomic, copy) PBInterstitialWillDismiss willDismiss;
// 弹出广告关闭完成的block
@property (nonatomic, copy) PBInterstitialDidDismiss didDismiss;
