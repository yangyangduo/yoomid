...
// 精品推荐加载完成
typedef void (^PBMoreGameDidLoadAD)();
// 精品推荐加载出错
typedef void (^PBMoreGameLoadFailure)(PBRequestError *error);
// 精品推荐打开完成
typedef void (^PBMoreGameDidPresent)();
// 精品推荐将要关闭
typedef void (^PBMoreGameWillDismiss)();
// 精品推荐关闭完成
typedef void (^PBMoreGameDidDismiss)();
...
// 精品推荐加载完成的block
@property (nonatomic, copy) PBMoreGameDidLoadAD didLoadAD;
// 精品推荐加载出错的block
@property (nonatomic, copy) PBMoreGameLoadFailure loadADFailure;
// 精品推荐打开完成的block
@property (nonatomic, copy) PBMoreGameDidPresent didPresent;
// 精品推荐将要关闭的block
@property (nonatomic, copy) PBMoreGameWillDismiss willDismiss;
// 精品推荐关闭完成的block
@property (nonatomic, copy) PBMoreGameDidDismiss didDismiss;
